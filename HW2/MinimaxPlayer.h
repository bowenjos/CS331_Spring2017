...
public:
	...
	char get_other_symbol(char symbol);

	int utility(OthelloBoard* cb);	

	int max(OthelloBoard* cb, int r, int c);

	int min(OthelloBoard* cb, int r, int c);

	mima firstMax(OthelloBoard* b);
